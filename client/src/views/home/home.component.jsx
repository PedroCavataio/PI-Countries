...
function Home() {
  ...
  const sortByPopulation = () => {
    ...
    return allCountries.sort(function(a, z) {
      const poblacionA = a.population ? parseFloat(a.population.replace(/\./g, '')) : a.population = 0;
      const poblacionZ = z.population ? parseFloat(z.population.replace(/\./g, '')) : z.population = 0;
      if (populationOrder) {
  ...
  const renderSortButtons = () => {
    return (
      <div className="sort-buttons">
        ...
        <button onClick={sortByPopulation}>
          Sort by Population
        </button>
      </div>
    )
